...
- Name: phase-2-context-mention.spec.ts >> Phase 2 — Context mentions >> token counter updates when text is typed
- Location: test\e2e\specs\phase-2-context-mention.spec.ts:29:7
