...
- Name: phase-1-streaming-chat.spec.ts >> Phase 1 — Streaming chat >> shows error banner on bad API key
- Location: test\e2e\specs\phase-1-streaming-chat.spec.ts:18:7
